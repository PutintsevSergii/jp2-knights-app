...
export const TRANSLATION_KEYS = [
  ...
  "admin.roadmapDefinitions.documentTitle",
  "admin.roadmapDefinitions.list.body",
  "admin.roadmapDefinitions.ready.body",
  "admin.roadmapDefinitions.loading.title",
  "admin.roadmapDefinitions.loading.body",
  "admin.roadmapDefinitions.empty.body",
  "admin.roadmapDefinitions.error.title",
  "admin.roadmapDefinitions.error.body",
  "admin.roadmapDefinitions.offline.body",
  "admin.roadmapDefinitions.forbidden.body",
  "admin.roadmapDefinitions.create",
  "admin.roadmapDefinitions.view",
  "admin.roadmapDefinitions.back",
  "admin.roadmapDefinitions.counts",
  "admin.roadmapDefinitions.notPublished",
  "admin.roadmapDefinitions.detail.fallbackTitle",
  "admin.roadmapDefinitions.detail.title",
  "admin.roadmapDefinitions.detail.ready.body",
  "admin.roadmapDefinitions.detail.loading.title",
  "admin.roadmapDefinitions.detail.loading.body",
  "admin.roadmapDefinitions.detail.empty.title",
  "admin.roadmapDefinitions.detail.empty.body",
  "admin.roadmapDefinitions.detail.error.title",
  "admin.roadmapDefinitions.detail.error.body",
  "admin.roadmapDefinitions.detail.offline.body",
  "admin.roadmapDefinitions.detail.noDescription",
...
export const ENGLISH_TRANSLATIONS: TranslationCatalog = {
  ...
  "admin.roadmapDefinitions.documentTitle": "Admin Roadmap Definitions",
  "admin.roadmapDefinitions.list.body":
    "Inspect configured candidate and brother roadmaps. Editing remains gated until approved formation wording is confirmed.",
  "admin.roadmapDefinitions.ready.body": "Roadmap definitions are ready.",
  "admin.roadmapDefinitions.loading.title": "Loading Roadmap Definitions",
  "admin.roadmapDefinitions.loading.body": "Roadmap definitions are loading.",
  "admin.roadmapDefinitions.empty.body": "No roadmap definitions are configured.",
  "admin.roadmapDefinitions.error.title": "Unable to Load Roadmap Definitions",
  "admin.roadmapDefinitions.error.body": "Roadmap definitions could not be loaded.",
  "admin.roadmapDefinitions.offline.body": "Reconnect to refresh roadmap definitions.",
  "admin.roadmapDefinitions.forbidden.body":
    "Super Admin access is required to inspect roadmap definitions.",
  "admin.roadmapDefinitions.create": "Create Roadmap",
  "admin.roadmapDefinitions.view": "View",
  "admin.roadmapDefinitions.back": "Back to Definitions",
  "admin.roadmapDefinitions.counts":
    "{{stageCount}} stage{{stagePluralSuffix}} · {{stepCount}} step{{stepPluralSuffix}} · {{assignmentCount}} assignment{{assignmentPluralSuffix}}",
  "admin.roadmapDefinitions.notPublished": "Not published",
  "admin.roadmapDefinitions.detail.fallbackTitle": "Roadmap Definition",
  "admin.roadmapDefinitions.detail.title": "Roadmap Definition: {{title}}",
  "admin.roadmapDefinitions.detail.ready.body": "Roadmap definition is ready.",
  "admin.roadmapDefinitions.detail.loading.title": "Loading Roadmap Definition",
  "admin.roadmapDefinitions.detail.loading.body": "Roadmap definition is loading.",
  "admin.roadmapDefinitions.detail.empty.title": "Roadmap Definition Not Found",
  "admin.roadmapDefinitions.detail.empty.body":
