...
Pilot seed should be created only from approved real data. It should include one pilot chorągiew, one super admin, one officer, 5-20 brothers, 1-5 candidates, and representative public/private content.
