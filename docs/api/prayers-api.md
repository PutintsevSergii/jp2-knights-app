...
- Admin create/update/archive/approve/publish mutations append audit log entries with actor, entity, scope, explicit lifecycle action names, and redacted before/after summaries. Full prayer bodies are not copied into audit summaries.
