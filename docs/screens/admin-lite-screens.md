...
- Phase 4 admin shell routes now expose `/admin/prayers` and `/admin/events`, resolving API/demo data into rendered documents. Production web hosting/Next.js mounting is still pending.
