...
| FR-PUBLIC-002 About the Order              | `GET /public/content-pages/{slug}`                                                                                                                                                                                                             | `AboutOrder`                                                                                                                        | content_pages                                                                                                                                                                  | approved and published `PUBLIC` content only, private/unapproved/missing pages 404, English fallback, mobile API/demo states, Stitch `About the Order` article layout with centered title/content panel/journey actions                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| FR-EVENT-001 Public Events                 | `GET /public/events`, `GET /public/events/:id`                                                                                                                                                                                                 | public event list/detail                                                                                                            | events                                                                                                                                                                         | approved public/family only, date filters, mobile list/detail API/demo states, Stitch `Public Events` intro/event card/details action layout                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
