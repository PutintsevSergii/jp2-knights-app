...
- Mobile now has an Expo entry point and React Native `PublicHome` screen that
  ...
  Home/About/Prayers/Events/Join public bottom tabs while keeping private
  candidate/brother content hidden.
...
| FR-PUBLIC-001 Public Home                  | `GET /public/home`                                                                                                                                                                                                                             | `PublicHome`                                                                                                                        | prayers, events, content pages                                                                                                                                                 | public no-auth, no private content, empty state, fixed public Home/About/Prayers/Events/Join bottom tabs, Stitch-aligned public home navigation, bento public actions, daily-prayer panel, upcoming-event rows, route-action renderer tests                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
