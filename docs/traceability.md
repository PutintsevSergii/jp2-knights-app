...
| FR-CANDIDATE-003 Candidate Announcements   | `GET /candidate/announcements`                                                                                                                                                                                                                 | dedicated Figma-aligned CandidateAnnouncements screen mounted in Expo                                                               | announcements                                                                                                                                                                  | active profile required, shared DTO/OpenAPI schemas, pinned sort, approved published public/family/candidate/own organization-unit filtering, mobile API/demo model/renderer tests, no brother/officer/admin/unrelated-scope announcements, no chat/comments/read receipts/push delivery state                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| FR-ANN-001 Brother Announcements           | `GET /brother/announcements`                                                                                                                                                                                                                   | BrotherAnnouncements screen model mounted in Expo                                                                                   | announcements                                                                                                                                                                  | active brother profile required, shared DTO/OpenAPI schemas, pinned sort, approved published public/family/brother/own organization-unit filtering, mobile API/demo state handling, no chat/comments/read receipts, no candidate/officer/admin/unrelated-scope announcements                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
