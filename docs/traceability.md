...
- Phase 10A role-aware main-screen redesign now includes the latest Google
  ...
  backend provider adapter for real liturgical day/season/rank/color data
  remains planned; mobile does not call an external calendar source directly.
...
| FR-PUBLIC-001 Public Home                  | `GET /public/home`; planned liturgical calendar provider adapter                                                                                                                                                                               | `PublicHome`                                                                                                                        | prayers, events, content pages; planned normalized liturgical day cache/source                                                                                                  | public no-auth, no private content, empty state, fixed public Home/About/Prayers/Events bottom tabs, Join shown only on anonymous guest Home, Stitch-aligned public home navigation, bento public actions, daily-prayer panel, upcoming-event rows, planned today/liturgical-day module, planned next guest-attendable Order event from public/family-open event contract, route-action renderer tests                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
