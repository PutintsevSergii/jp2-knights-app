...
**Last Updated**: May 16, 2026 (Phases 0–9 complete; Phase 10A V1 Figma/RBAC alignment in progress; Phase 10B roadmap data/contracts started)
...
- Phase 10A implementation should next add pilot Firebase/Google environment
  ...
  roadmap read APIs over the new data/contracts.
...
| FR-ROADMAP-001 Candidate Roadmap           | `GET /candidate/roadmap` planned; shared assigned-roadmap DTO contract defined                                                                                                                                                                 | candidate roadmap planned                                                                         | `roadmap_definitions`, `roadmap_stages`, `roadmap_steps`, `roadmap_assignments`; demo candidate roadmap seed                                                                   | Phase 10B data/contracts foundation exists; assigned-candidate read API and mobile screen remain next                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| FR-ROADMAP-002 Formation Roadmap           | `GET /brother/roadmap` planned; shared assigned-roadmap DTO contract defined                                                                                                                                                                   | formation roadmap planned                                                                         | `roadmap_definitions`, `roadmap_stages`, `roadmap_steps`, `roadmap_assignments`; demo brother roadmap seed                                                                     | Phase 10B data/contracts foundation exists; own-roadmap read API and mobile screen remain next; no auto degree                                                                                                                                                                                                                                                                                                                                                                                                                |
| FR-ROADMAP-003 Roadmap Step Submission     | `POST /brother/roadmap/steps/:stepId/submissions` planned; shared create-submission DTO contract defined                                                                                                                                       | step detail planned                                                                               | `roadmap_submissions` with optional `attachment_meta`; demo pending brother submission seed                                                                                    | Phase 10B data/contracts foundation exists; pending duplicate constraint exists; write API and attachment policy enforcement remain next                                                                                                                                                                                                                                                                                                                                                                                      |
| FR-ROADMAP-004 Roadmap Approval            | `GET/PATCH /admin/roadmap-submissions/:id` planned; shared review DTO contract defined                                                                                                                                                         | roadmap request detail planned                                                                    | `roadmap_submissions`, future audit_logs side effects                                                                                                                          | Phase 10B data/contracts foundation exists; rejection-comment validation exists in shared DTO; scoped review API and audit side effects remain next                                                                                                                                                                                                                                                                                                                                                                           |
