...
- Phase 10B now starts the owner-approved roadmap assignment mutation workflow
  ...
  email or submission body text. Admin Lite exposes typed create client support
  and create action metadata while the rendered form workflow remains a follow-up.
...
- Phase 10A implementation should next add pilot Firebase/Google environment
  ...
  Lite create-assignment form flow, owner-approved definition mutation workflow,
  or a dedicated brother submission screen flow after confirmation of the exact
  formation wording.
