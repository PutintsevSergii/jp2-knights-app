...
**Exit criteria**: 🟡 Audit review surface with filtering/pagination, candidate request export/erasure, candidate profile export/erasure, first publish approval guard across core admin content, and Admin Lite approval-before-publish action guidance including silent-prayer list workflow started; broader retention, remaining erasure/export coverage, production approval workflow polish, and final privacy/security hardening still pending
...
| ------------------------ | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Lint**                 | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Full `pnpm quality` lint passed after the Phase 12 audit-log filtering/pagination slice                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| **Typecheck**            | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Full `pnpm quality` typecheck passed across all apps/libs after the Phase 12 audit-log filtering/pagination slice                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| **Unit tests (80%)**     | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | `vitest --coverage`: 91.16% statements / 80.06% branches / 91.11% functions / 91.43% lines; latest Stitch role-aware mobile home renderers for guest/candidate/brother/Idle approval, Stitch bottom-tab icon routing, previous Stitch public mobile renderer paths, Phase 12 audit-log filtering/pagination, export/erasure, device-token revocation, content approval enforcement, lifecycle mutation helpers, and privacy fallback branches are covered in addition to prior Phase 11 silent-prayer REST/presence/socket/admin/mobile coverage |
| **Integration tests**    | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Candidate/brother event read, participation, announcement read, mobile private routing/renderer, role-aware home renderer navigation, provider sign-in session bridge, Expo/Firebase Google provider adapter/config parsing, Brother Prayer Library and Organization Unit Detail mobile route/rendering, mobile public/brother silent-prayer REST list/join screen coverage, mobile Socket.IO heartbeat/leave/reconnect client coverage, Admin Lite Candidate Requests responsive list/detail rendering, admin candidate profile export/erasure client/API coverage, auth device-token registration/revocation API coverage, admin announcement API/list/editor UI, Admin Lite audit-log query pass-through and exact-total pagination coverage, Admin Lite silent-prayer list API/shell/Next route coverage, notification preference, push recipient dispatch coverage, Phase 10B mobile/admin localization adapter coverage, Admin Lite roadmap review API/shell coverage, Super Admin roadmap definition/assignment inspection/creation coverage, Phase 11 silent-prayer public/brother REST/service/admin coverage, and Phase 12 audit-log filter/client plus candidate request export/erasure coverage |
| **Build**                | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Full `pnpm quality` build passed across all apps/libs after the Phase 12 audit-log filtering/pagination slice                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| **OpenAPI generation**   | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Generated contract includes the Phase 12 audit-log query filters/pagination response, candidate request export/erasure endpoints, candidate profile export/erasure endpoints, self-service device-token revocation endpoint, and prior roadmap, silent-prayer, candidate/brother event, participation, announcement, admin announcement, and auth notification endpoints                                                                                                                                                                                                                                                                                                       |
| **Contract check**       | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Contract check passed after regenerating `generated/openapi.json`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| **DB migration check**   | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Prisma schema and migration baseline validate; no migration required for this audit-log filtering/pagination slice                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
