...
| **13**    | ⏳ PENDING     | 4%       | █░░░░░░░░░░░░░░░░░░░ | Pilot readiness planning started with Google Cloud launch docs, Terraform plan, environment/secrets matrix, manual owner task split, workflow timing that keeps Docker/Terraform implementation near the end of V1, Firebase Realtime Database silent-prayer migration plan, and June 3, 2026 owner decision that live pilot/production must not provision Redis/Memorystore                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Implement RTDB silent-prayer slice before live Terraform |
...
- [ ] Implement the Firebase RTDB silent-prayer provider before live Terraform work: do not provision Redis/Memorystore for pilot or production, add API heartbeat/leave contracts, add RTDB rules/tests, switch mobile realtime through a provider-neutral client, and verify aggregate-only public/brother counts on a device
