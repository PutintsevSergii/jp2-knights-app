...
| **12**    | 🟡 IN PROGRESS | 62%      | ████████████░░░░░░░░ | Super Admin audit-log API with shared filters/pagination and exact filtered totals, mounted Admin Lite query pass-through, visible audit filter form, action preset select, and pagination links, Admin Lite audit review route/client validation, candidate request/profile/roadmap submission export-erasure, self-service device-token revocation, shared retention bucket contract, content publish approval enforcement for prayer/event/announcement/silent-prayer content, explicit content lifecycle audit actions, Admin Lite approval-before-publish action workflow including silent-prayer list route, and typed lifecycle mutation helpers started                                                                                                                                                                                                 | Continue retention/erasure/content approval hardening |
...
| ------------------------ | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Lint**                 | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Full `pnpm quality` lint passed after the Phase 12 shared retention bucket contract slice                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| **Typecheck**            | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Full `pnpm quality` typecheck passed across all apps/libs after the Phase 12 shared retention bucket contract slice                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| **Unit tests (80%)**     | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | `vitest --coverage`: 91.24% statements / 80.17% branches / 91.14% functions / 91.50% lines; latest Stitch role-aware mobile home renderers for guest/candidate/brother/Idle approval, Stitch bottom-tab icon routing, previous Stitch public mobile renderer paths, Phase 12 audit-log filtering/pagination/action presets, shared retention bucket contract, export/erasure, roadmap submission export/erasure, content lifecycle audit actions, device-token revocation, content approval enforcement, lifecycle mutation helpers, and privacy fallback branches are covered in addition to prior Phase 11 silent-prayer REST/presence/socket/admin/mobile coverage |
| **Integration tests**    | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Candidate/brother event read, participation, announcement read, mobile private routing/renderer, role-aware home renderer navigation, provider sign-in session bridge, Expo/Firebase Google provider adapter/config parsing, Brother Prayer Library and Organization Unit Detail mobile route/rendering, mobile public/brother silent-prayer REST list/join screen coverage, mobile Socket.IO heartbeat/leave/reconnect client coverage, Admin Lite Candidate Requests responsive list/detail rendering, admin candidate profile export/erasure client/API coverage, auth device-token registration/revocation API coverage, admin announcement API/list/editor UI and explicit content lifecycle audit action coverage, Admin Lite audit-log query pass-through, action preset, and exact-total pagination coverage, Admin Lite silent-prayer list API/shell/Next route coverage, notification preference, push recipient dispatch coverage, Phase 10B mobile/admin localization adapter coverage, Admin Lite roadmap review and roadmap submission export/erasure API/client coverage, Super Admin roadmap definition/assignment inspection/creation coverage, Phase 11 silent-prayer public/brother REST/service/admin coverage, and Phase 12 audit-log filter/client plus candidate request export/erasure coverage |
| **Build**                | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Full `pnpm quality` build passed across all apps/libs after the Phase 12 shared retention bucket contract slice                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| **OpenAPI generation**   | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Generated contract includes the Phase 12 audit-log query filters/pagination response, candidate request export/erasure endpoints, candidate profile export/erasure endpoints, roadmap submission export/erasure endpoints, self-service device-token revocation endpoint, and prior roadmap, silent-prayer, candidate/brother event, participation, announcement, admin announcement, and auth notification endpoints                                                                                                                                                                                                                                                                    |
| **Contract check**       | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Contract check passed after regenerating `generated/openapi.json`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| **DB migration check**   | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Prisma schema and migration baseline validate; no migration required for this shared retention bucket contract slice                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
