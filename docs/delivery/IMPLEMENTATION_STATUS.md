...
- 🟡 Physical native-device RTDB validation and launch smoke verification

**Not Yet**:

- ⏳ Production Dockerfiles, Terraform resources, Cloud Run deployment scripts, backup/restore procedure, and launch smoke checklist

**Exit criteria**: 🟡 Planning, API RTDB-prep contracts, mobile listener support, RTDB rules baseline, API RTDB provider/publisher, Firebase emulator rules tests, native validation preflight, and Cloud Run/Cloud SQL Prisma hardening complete; physical native-device validation and deployment foundation pending
