...
| ------------------------ | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Lint**                 | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Full `pnpm quality` lint passed after the Phase 12 candidate request erasure slice                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| **Typecheck**            | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Full `pnpm quality` typecheck passed across all apps/libs after the Phase 12 candidate request erasure slice                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| **Unit tests (80%)**     | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | `vitest --coverage`: 91.39% statements / 80.37% branches / 91.77% functions / 91.47% lines; Phase 12 audit-log API/service/repository, shared validation, Admin Lite API/model/shell/Next route, candidate request export, candidate request erasure, and privacy fallback branches are covered in addition to prior Phase 11 silent-prayer REST/presence/socket/admin/mobile coverage                                                                                                                                                                                                            |
...
| **Build**                | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Full `pnpm quality` build passed across all apps/libs after the Phase 12 candidate request erasure slice                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| **DB migration check**   | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Prisma schema and migration baseline validate; no migration required for this anonymization/archive slice                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
