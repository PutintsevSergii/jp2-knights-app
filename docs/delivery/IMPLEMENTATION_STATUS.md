...
- ✅ Super Admin-only `GET /admin/candidates/:id/export` added for candidate profile personal-data export, including archived profiles, with redacted export audit summaries that omit candidate email and display name
...
| **OpenAPI generation**   | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Generated contract includes the Phase 12 audit-log query filters/pagination response, candidate request export/erasure endpoints, candidate profile export/erasure endpoints, roadmap submission export/erasure endpoints with sensitive-review retention bucket metadata, self-service device-token revocation endpoint, and prior roadmap, silent-prayer, candidate/brother event, participation, announcement, admin announcement, and auth notification endpoints                                                                                                                                                                                                                   |
