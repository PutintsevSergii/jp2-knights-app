...
| **12**    | 🟡 IN PROGRESS | 42%      | ████████░░░░░░░░░░░░ | Super Admin read-only audit-log API, Admin Lite audit review route, candidate request personal-data export, candidate profile personal-data export, candidate request legal erasure, candidate profile legal erasure for candidate-only users, content publish approval enforcement for prayer/event/announcement/silent-prayer content, Admin Lite approval-before-publish action workflow, and typed lifecycle mutation helpers started                                                                                                                                                                                                                                                                                                                                                                                                                          | Continue retention/export/content approval hardening |
...
| ------------------------ | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Lint**                 | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Full `pnpm quality` lint passed after the Phase 12 candidate profile erasure slice                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| **Typecheck**            | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Full `pnpm quality` typecheck passed across all apps/libs after the Phase 12 candidate profile erasure slice                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| **Unit tests (80%)**     | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | `vitest --coverage`: 91.54% statements / 80.51% branches / 91.98% functions / 91.62% lines; Phase 12 audit-log API/service/repository, shared validation, Admin Lite API/model/shell/Next route, candidate request export, candidate profile export, candidate request erasure, candidate profile erasure, content approval enforcement, Admin Lite approval action workflow, typed lifecycle mutation helpers, and privacy fallback branches are covered in addition to prior Phase 11 silent-prayer REST/presence/socket/admin/mobile coverage                                                        |
| **Integration tests**    | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Candidate/brother event read, participation, announcement read, mobile private routing/renderer, provider sign-in session bridge, Expo/Firebase Google provider adapter/config parsing, Brother Prayer Library and Organization Unit Detail mobile route/rendering, mobile public/brother silent-prayer REST list/join screen coverage, mobile Socket.IO heartbeat/leave/reconnect client coverage, Admin Lite Candidate Requests responsive list/detail rendering, admin candidate profile export/erasure client/API coverage, admin announcement API/list/editor UI, notification preference/device-token, push recipient dispatch coverage, Phase 10B mobile/admin localization adapter coverage, Admin Lite roadmap review API/shell coverage, Super Admin roadmap definition/assignment inspection/creation coverage, Phase 11 silent-prayer public/brother REST/service/admin coverage, and Phase 12 audit-log plus candidate request export/erasure coverage |
| **Build**                | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Full `pnpm quality` build passed across all apps/libs after the Phase 12 candidate profile erasure slice                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| **OpenAPI generation**   | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Generated contract includes the Phase 12 candidate request export/erasure endpoints, candidate profile export/erasure endpoints, and prior roadmap, silent-prayer, candidate/brother event, participation, announcement, admin announcement, and auth notification endpoints                                                                                                                                                                                                                                                                                                                                                                                                    |
| **Contract check**       | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Contract check passed after regenerating `generated/openapi.json`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| **DB migration check**   | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Prisma schema and migration baseline validate; no migration required for this candidate profile erasure slice                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
