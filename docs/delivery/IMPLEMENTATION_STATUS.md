...
**Status**: IN PROGRESS (approved V1 scope; mobile shell split complete, roadmap read/submission/review/definition/assignment-inspection, assignment-create form, roadmap assignment/submission/definition localization cleanup, and SOLID/Clean Architecture aggregation cleanup slices complete)
...
| **Build**                | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Repo-wide build passed across all apps/libs after the Phase 13 API RTDB provider/publisher slice                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| **OpenAPI generation**   | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Generated contract includes the Phase 13 public/brother silent-prayer heartbeat/leave endpoints, Phase 12 audit-log query filters/pagination response, candidate request export/erasure endpoints, candidate profile export including local role lifecycle rows, identity access review history, membership history, officer assignment history, roadmap assignment lifecycle metadata, own event participation intent lifecycle metadata, provider account mirrors, safe device-token lifecycle metadata, and notification preferences plus erasure endpoint, roadmap submission export/erasure endpoints with sensitive-review retention bucket metadata, self-service device-token revocation endpoint, admin content approval/publish actor metadata, and prior roadmap, silent-prayer, candidate/brother event, participation, announcement, admin announcement, and auth notification endpoints                                                                                                                                                                                   |
| **Contract check**       | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Contract generation/check passed after regenerating `generated/openapi.json` with the Phase 13 silent-prayer REST heartbeat/leave endpoints                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| **DB migration check**   | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Prisma schema and migration baseline validate; no migration required for the Phase 13 API RTDB provider/publisher slice                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| **Demo mode smoke test** | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | `pnpm smoke:launch` passed inside escalated `pnpm quality`; the non-escalated sandboxed run reached this gate and failed only on `listen EPERM 127.0.0.1`                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
5. **Start Phase 10A Figma/RBAC Alignment**
   ...
   - [ ] Plan and implement an API-side liturgical calendar provider adapter and
