...
| **10**    | 🟡 IN PROGRESS | 91%      | ██████████████████░░ | V1 Figma/RBAC alignment started; mobile shell split complete; Figma cache, Gold/Grey tokens, Google/Firebase auth-entry styling/session bridge/Expo adapter, Candidate Events list/detail, Candidate Announcements, Brother Today, Brother Events, Brother Event Detail, Brother Announcements, Brother Prayer Library, Organization Unit Detail, responsive Admin Lite Candidate Requests, Phase 10B localization foundation, roadmap data/contracts, candidate/brother roadmap read APIs/screen models, brother roadmap submission API and mobile flow, realistic multi-scope roadmap seed/load fixtures, Admin Lite roadmap review workflow, Super Admin read-only roadmap definition inspection, Super Admin roadmap assignment inspection, Super Admin roadmap assignment creation API/client/rendered form support, and roadmap assignment/submission/definition localization cleanup complete | Phase 11 sockets/Redis |
| **11**    | 🟡 IN PROGRESS | 75%      | ███████████████░░░░░ | Silent-prayer event table/migration/fixtures, public and brother REST list/join contracts, Redis-shaped presence boundary, deterministic in-memory store, Socket.IO namespace/gateway, Redis-backed presence store, Socket.IO Redis adapter, production Redis fail-fast config, Admin Lite silent-prayer event management API/audit workflow, mobile public/brother silent-prayer REST list/join screens, and duplicate-join/reconnect/TTL/scope/socket/Redis/admin/mobile tests                                                                                                                           | Mobile Socket.IO heartbeat client |
| **12–13** | ⏳ PENDING     | 0%       | ░░░░░░░░░░░░░░░░░░░░ | Privacy/security hardening and pilot                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | After Phase 11                |

---

## Phase 10: V1 Figma/RBAC Alignment + Formation Roadmap 🟡

**Status**: IN PROGRESS (approved V1 scope; mobile shell split complete, roadmap read/submission/review/definition/assignment-inspection, assignment-create form, and roadmap assignment/submission/definition localization cleanup slices complete)
...
| **11** | Silent Online Prayer                     | 🟡 In progress | Current         |
...
- 🟡 Mobile live Socket.IO client integration for heartbeat/leave/reconnect updates after the REST join returns socket-room metadata

**Exit criteria**: 🟡 Event persistence, public/brother REST presence, Socket.IO gateway, Redis wiring, admin workflow, and mobile REST session screens complete; live mobile socket heartbeat loop still pending

**Next step**: Implement mobile Socket.IO heartbeat/leave/reconnect client behavior for silent-prayer sessions
...
| ------------------------ | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Lint**                 | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Phase 10B roadmap assignment creation slice passed full `pnpm quality` lint                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| **Typecheck**            | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Phase 10B roadmap assignment creation slice passed full `pnpm quality` typecheck                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| **Unit tests (80%)**     | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | `vitest --coverage`: 90.5% statements / 80.33% branches / 90.95% functions / 90.59% lines; Phase 11 silent-prayer REST/presence core plus Socket.IO gateway, Redis store, Admin Lite management API, shared admin validation, and mobile silent-prayer API/model/renderer paths have duplicate-join/reconnect/TTL/multi-instance/scope/socket/privacy/Redis/admin/mobile coverage                                                                                                                                                                                                                         |
| **Integration tests**    | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Candidate/brother event read, participation, announcement read, mobile private routing/renderer, provider sign-in session bridge, Expo/Firebase Google provider adapter/config parsing, Brother Prayer Library and Organization Unit Detail mobile route/rendering, mobile public/brother silent-prayer REST list/join screen coverage, Admin Lite Candidate Requests responsive list/detail rendering, admin announcement API/list/editor UI, notification preference/device-token, push recipient dispatch coverage, Phase 10B mobile/admin localization adapter coverage, Admin Lite roadmap review API/shell coverage, Super Admin roadmap definition/assignment inspection coverage, Super Admin roadmap assignment creation coverage, Phase 11 silent-prayer public/brother REST service coverage, and Admin Lite silent-prayer controller/service/repository coverage; live Socket.IO client integration remains pending |
| **Build**                | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Phase 10B roadmap assignment creation slice passed full `pnpm quality` build                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| **OpenAPI generation**   | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Generated contract includes roadmap submission review, roadmap definition inspection, roadmap assignment inspection, roadmap assignment creation schemas, silent-prayer public/brother list/join schemas, Admin Lite silent-prayer event management schemas, and existing candidate/brother event, participation, announcement, admin announcement, and auth notification endpoints                                                                                                                                                                                                                                                                                        |
...
**Current Phase**: Phase 10 Figma/RBAC alignment and Formation Roadmap plus Phase 11 realtime foundation in progress; Phases 0–9 complete
**Next Major Milestone**: Implement mobile silent-prayer Socket.IO heartbeat/leave/reconnect behavior; definition mutation remains pending owner confirmation of exact formation wording.
