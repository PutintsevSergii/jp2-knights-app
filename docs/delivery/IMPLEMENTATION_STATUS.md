...
- ⏳ Cloud Run deployment scripts, backup/restore procedure, launch smoke checklist, live Terraform apply, and physical native-device RTDB validation

**Exit criteria**: 🟡 Planning, API RTDB-prep contracts, mobile listener support, RTDB rules baseline, API RTDB provider/publisher, Firebase emulator rules tests, native validation preflight, Cloud Run/Cloud SQL Prisma hardening, local containerization baseline, Terraform foundation, Cloud SQL, migration job, and Firebase RTDB provisioning/import wiring complete; physical native-device validation, deployment scripts, backup/restore, live Terraform apply, and launch-smoke validation pending

**Next step**: Run native-device RTDB validation before live Terraform
...
| **Build**                | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Repo-wide build passed across all apps/libs after the Phase 10A public/candidate/brother today module and cached/retried provider slice                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| **DB migration check**   | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Prisma schema and migration baseline validate; no migration required for the Phase 10A liturgical provider config/runtime slice                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
**Next Major Milestone**: Phase 13 pilot readiness: implement the Firebase RTDB silent-prayer slice with no Redis/Memorystore live dependency, then build the Google Cloud Docker/Terraform foundation and launch-readiness controls.
