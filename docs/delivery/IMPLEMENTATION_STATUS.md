...
| ------------------------ | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Lint**                 | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Full `pnpm quality` lint passed after the Phase 12 Admin Lite silent-prayer route slice                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| **Typecheck**            | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Full `pnpm quality` typecheck passed across all apps/libs after the Phase 12 Admin Lite silent-prayer route slice                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| **Unit tests (80%)**     | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | `vitest --coverage`: 91.59% statements / 80.61% branches / 92.05% functions / 91.67% lines; Phase 12 audit-log API/service/repository, shared validation, Admin Lite API/model/shell/Next route, candidate request export, candidate profile export, candidate request erasure, candidate profile erasure, self-service device-token revocation, content approval enforcement, Admin Lite approval action workflow including silent-prayer list routing, typed lifecycle mutation helpers, and privacy fallback branches are covered in addition to prior Phase 11 silent-prayer REST/presence/socket/admin/mobile coverage |
| **Integration tests**    | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Candidate/brother event read, participation, announcement read, mobile private routing/renderer, provider sign-in session bridge, Expo/Firebase Google provider adapter/config parsing, Brother Prayer Library and Organization Unit Detail mobile route/rendering, mobile public/brother silent-prayer REST list/join screen coverage, mobile Socket.IO heartbeat/leave/reconnect client coverage, Admin Lite Candidate Requests responsive list/detail rendering, admin candidate profile export/erasure client/API coverage, auth device-token registration/revocation API coverage, admin announcement API/list/editor UI, Admin Lite silent-prayer list API/shell/Next route coverage, notification preference, push recipient dispatch coverage, Phase 10B mobile/admin localization adapter coverage, Admin Lite roadmap review API/shell coverage, Super Admin roadmap definition/assignment inspection/creation coverage, Phase 11 silent-prayer public/brother REST/service/admin coverage, and Phase 12 audit-log plus candidate request export/erasure coverage |
| **Build**                | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Full `pnpm quality` build passed across all apps/libs after the Phase 12 Admin Lite silent-prayer route slice                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| **DB migration check**   | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | ✅      | Prisma schema and migration baseline validate; no migration required for this Admin Lite silent-prayer route slice                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
