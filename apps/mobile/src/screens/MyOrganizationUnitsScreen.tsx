...
export interface MyOrganizationUnitsScreenProps {
  ...
  onNavigate?: (route: MyOrganizationUnitsScreenModel["actions"][number]["targetRoute"]) => void;
}

export function MyOrganizationUnitsScreen({
  screen,
  onNavigate
}: MyOrganizationUnitsScreenProps) {
  return (
