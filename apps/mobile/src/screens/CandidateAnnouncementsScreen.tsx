...
export interface CandidateAnnouncementsScreenProps {
  screen: CandidateAnnouncementsScreenModel;
  onAction?: (action: CandidateScreenAction) => void;
}

export function CandidateAnnouncementsScreen({
  screen,
  onAction
}: CandidateAnnouncementsScreenProps) {
  return (
