...
import type { JoinRequestConfirmationScreen as JoinRequestConfirmationScreenModel } from "../public-screens.js";

export interface JoinRequestConfirmationScreenProps {
  screen: JoinRequestConfirmationScreenModel;
  onNavigate?: (
    route: JoinRequestConfirmationScreenModel["actions"][number]["targetRoute"]
  ) => void;
}

export function JoinRequestConfirmationScreen({
  screen,
  onNavigate
}: JoinRequestConfirmationScreenProps) {
  return (
